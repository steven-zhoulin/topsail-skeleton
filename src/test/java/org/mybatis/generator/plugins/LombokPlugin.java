...
public class LombokPlugin extends PluginAdapter {
     ...
     */
    public LombokPlugin() {
        annotations = new LinkedHashSet<LombokPlugin.Annotations>(LombokPlugin.Annotations.values().length);
    }
    ...
    public void setProperties(Properties properties) {
        ...
        for (String annotationName : properties.stringPropertyNames()) {
            ...
            LombokPlugin.Annotations annotation = LombokPlugin.Annotations.getValueOf(annotationName);
            if (annotation == null) {
                continue;
            }
